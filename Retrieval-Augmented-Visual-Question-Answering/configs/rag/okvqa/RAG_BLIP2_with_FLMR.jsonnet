...
local tokenizer_config = {
  "tokenizer": {
    ...
    "TokenizerModelVersion": "/workspace/RAVQA_v2_data/checkpoints/colbertv2.0",
    "SPECIAL_TOKENS":{
...
local index_files = {
  ...
  "embedding_path": "",
  "static_results": [
    "/workspace/Retrieval-Augmented-Visual-Question-Answering/experiments/OKVQA_FLMR_9ROI_with_text_based_vision_generate_index/test/generate_index/generate_index_test_OKVQADatasetForDPR.train_predictions_rank_0.json",
    "/workspace/Retrieval-Augmented-Visual-Question-Answering/experiments/OKVQA_FLMR_9ROI_with_text_based_vision_generate_index/test/generate_index/generate_index_test_OKVQADatasetForDPR.test_predictions_rank_0.json",
  ],
};
local QueryEncoderModelVersion = "/workspace/RAVQA_v2_data/checkpoints/colbertv2.0";
