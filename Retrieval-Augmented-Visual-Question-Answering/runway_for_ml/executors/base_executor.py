...
class BaseExecutor(pl.LightningModule):
    ...
    def on_validation_end(self) -> None:
        ...
        print("Validation recorder saved to %s", self.valid_eval_recorder.save_dir)
    ...
    def on_test_end(self) -> None: 
        ...
        logging.warning("Test evaluation recorder saved to %s", self.test_eval_recorder.save_dir)
