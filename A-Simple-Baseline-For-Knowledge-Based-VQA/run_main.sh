...
python main.py \
    ...
    --train_images_dir /workspace/RAVQA_v2_data/okvqa/train2014/ \
    --val_images_dir /workspace/RAVQA_v2_data/okvqa/val2014/ \
    ...
    --llama_path /workspace/A-Simple-Baseline-For-Knowledge-Based-VQA/models/llama3 \
    ...
    --path_to_save_preds results/ok_vqa_val_with_mcan_llama3.csv
